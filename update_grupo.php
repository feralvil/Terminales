        ...
        if ($permiso == 2){
            ...
            if ($origen == "impexcel"){
                    ...
                    if ($objPHPExcel->getActiveSheet()->getCellByColumnAndRow($columna, $fila)->getValue() != ""){
                        ...
                        while ((!$leido) && ($fila < $maxfilas)){
                            ...
                            if ($gissi == ""){
                                ...
                                $arrygissi = array('GISSI' => trim($gissi), 'MNEMONICO' => $mnemo);
                ...
                foreach ($grupos as $grupo){
                    ...
                    $res_update = mysql_query($sql_gruposflotas) or die("Error al guardar los Grupos de Flota: " . $sql_gruposflotas . " - " . mysql_error());
                }
            }
            if ($res_update){
                $enlace = $enlaceok;
