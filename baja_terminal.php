...
<html>
    <head>
        ...
        <title><?php echo $titbaja; ?> del Terminal COMDES</title>
...
?>
    <body>
        <h1><?php echo $titbaja; ?> del Terminal TEI: <?php echo $row_terminal["TEI"]; ?> / ISSI: <?php echo $row_terminal["ISSI"]; ?> de la Flota <?php echo $row_flota["FLOTA"]; ?> (<?php echo $row_flota["ACRONIMO"]; ?>)</h1>
        <form action="update_terminal.php" method="POST" name="formterminal">
<?php
        if ($row_terminal["ESTADO"] == 'B') {
?>
            <h2>Terminal de <?php echo $titbaja; ?></h2>
            <div id="resultado">
                <p><img src='imagenes/error.png' alt='Error'></p>
                <p class="error"><?php echo $errbaja; ?></p>
                <p>
...
<?php
            ...
            $row_flota = mysql_fetch_array($res_flota);
?>
            <h2>Confirmar <?php echo $titbaja; ?></h2>
            ...
            <div class="centro">
                ...
                <p class="error"><?php echo $mensbaja; ?></p>
                <table>
                    <tr>
                        <td class="borde">
