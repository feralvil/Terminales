...
$lang = "idioma/permisosdel_$idioma.php";
include ($lang);
...
<html lang="es">
    ...
    ?>
        <form name="formtab" action="permisos_flodel.php" method="POST" target="_blank">
    ...
    ?>
            ...
            if ($ngrupos > 0){
            ?>
                <form name="formadd" action="permisos_flodel.php" method="POST">
                    <input name="idflota" type="hidden" value="<?php echo $idflota; ?>">
                ...
                ?>
                        <form name="formupdate" action="update_permiso.php" method="post">
                            ...
                            <input name="origen" type="hidden" value="permdel">
                        <table>
                            <tr>
                                <td>&nbsp;</td>
                                <th colspan="<?php echo $ncarpterm;?>">
