...
<head>
    ...
    <title><?php echo $titalta;?> de la Flota COMDES</title>
...
?>
    <h1>Activar la Flota <?php echo $flota_org;?> (<?php echo $acro_org;?>)</h1>
<?php
                if ($row_flota["ACTIVO"]=="SI"){
?>
                    <h2>Flota <?php echo $flota_org;?> (<?php echo $acro_org;?>) activada</h2>
                    <div id="resultado">
                        <p><img src='imagenes/error.png' alt='Error'></p>
                        <p><span class="error"><?php echo $erralta;?></span></p>
...
?>
                    ...
                    <form name="formaflota" action="update_flota.php" method="POST">
                        ...
                        <div class="centro">
                            ...
                            <p><span class="error"><?php echo $mensalta;?></span></p>
                            <table>
                                    <TR>
                                            <TD class="borde">
