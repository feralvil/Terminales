...
?>
    ...
    <body>
        ...
        ?>    
            <h1><?php echo $h1add . " " . $roltxt; ?> de la Flota <?php echo $row_flota['FLOTA']; ?> (<?php echo $row_flota['ACRONIMO']; ?>)</h1>
            <h2><?php echo $h2contexist; ?></h2>
            <form name="updateexist" action="update_contacto.php" method="post">
            ...
            <form name="updatenew" action="update_contacto.php" method="post">
                <input type="hidden" name="origen" value="addnew">
                <input type="hidden" name="idflota" value="<?php echo $idflota;?>"><?php                        
                if ($rol == "Nada"){
                ?>
                    <h3><?php echo $h3rol; ?></h3>
                    <select name="rol" id="selrol">
