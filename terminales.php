...
<?php
        if (($flota_usu == 0) && ($resetpassw < 1)){
            $destino = "https://intranet.comdes.gva.es/cvcomdes/";
?>
            <script type="text/javascript">
                window.top.location.href = "<?php echo $destino;?>";
            </script>
<?php
        }
?>
...
<?php
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="marca" onChange="document.criterios.submit();">
                                <option value="00" <?php if (($marca == "00") || ($marca == "")) echo 'selected'; ?>>Marca</option>
    <?php
                                $sql_marca = "SELECT DISTINCT MARCA FROM terminales WHERE 1";
                                if (($flota != "") && ($flota != "NN")){
                                    $sql_marca .= " AND terminales.FLOTA = '". $flota."'";
                                }
                                $sql_marca .= " ORDER BY MARCA ASC";
    ...
    ?>
                             ...
                             &mdash;
                            <select name="modelo" onChange="document.criterios.submit();">
                                <option value="00" <?php if (($modelo == "00") || ($modelo == "")) echo 'selected'; ?>>Modelo</option>
    <?php
                                $sql_modelo = "SELECT DISTINCT MODELO FROM terminales WHERE 1";
                                if (($marca != '') && ($marca != "00")) {
                                    $sql_modelo .= " AND (terminales.MARCA='$marca')";
                                }
                                if (($flota != "") && ($flota != "NN")){
                                    $sql_modelo .= " AND terminales.FLOTA = '". $flota."'";
                                }
                                $sql_modelo .= " ORDER BY MODELO ASC";
                                ...
                                for ($i = 0; $i < $nmodelo; $i++) {
                                    ...
                                    if ($row_modelo[0] != "") {
    ?>
                                        <option value="<?php echo $row_modelo[0];?>" <?php if ($modelo == $row_modelo[0]) echo 'selected'; ?>><?php echo $row_modelo[0];?></option>
    <?php
                                    }
                                }
    ?>
                            ...
                            ?>
                                &mdash;
                                <a href="#" onclick="document.edimodelo.submit();"><img src="imagenes/editar.png" alt="Editar" title="Editar"></a>
                            <?php
                            }
                            ?>
                        </td>
    ...
    ?>
                            <td class="borde">
                                <a href="#" onclick="document.newterminal.submit();"><img src="imagenes/nueva.png" alt="<?php echo $newter; ?>"  title="<?php echo $newter; ?>"></a> &mdash;
                                <a href="exptermtotal.php" target="_blank"><img src="imagenes/descargar.png" alt="<?php echo $txtdescarga; ?>" title="<?php echo $txtdescarga; ?>"></a>
                            </td>
                <?php
                        }
            ...
            <form name="edimodelo" action="modelo_terminal.php" method="POST">
    ...
    ?>
                        ...
                        <td><?php echo $row_term["ENCRIPTADO"];?></td>
                    </tr>
    <?php
                }  //primer for
            } //else if ($nterm == 0)
