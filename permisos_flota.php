...
<html lang="es">
    ...
    ?>
        ...
        ?>
            ...
            <form name="selflota" action="permisos_flota.php" method="post">
    ...
    ?>
            ...
            if ($ngrupos > 0){
                ...
                $sql_carpterm .= " ORDER BY permisos_flotas.ID ASC";
                        ...
                        ?>
                            <tr <?php if (($i % 2) == 1) {echo "class = 'filapar'";} ?>>
                                ...
                                foreach ($carpetas as $carpeta) {
                                    ...
                                    if ($npermiso > 0){
                                        $permiso = "X";
                                        $filapermiso = mysql_fetch_array($res_permiso);
                                        if ($filapermiso['NOMBRE'] != "-"){
                                            $permiso = $filapermiso['NOMBRE'];
                                        }
                                    }
                                ?>
