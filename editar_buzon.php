...
$lang = "idioma/buzonedi_$idioma.php";
include ($lang);
...
?>
            ...
            <form id="formbuzon" name="formbuzon" method="POST" action="update_buzon.php">
                ...
                <table>
                    ...
                    <tr>
                        <td><input type="text" name="acronimo" id="inputAcro" value="<?php echo $buzon['ACRONIMO']; ?>" size="20"></td>
                        <td><input type="text" name="nombre" id="inputNom" value="<?php echo $buzon['NOMBRE']; ?>" size="40"></td>
                        <td>
                            <select name="activo">
                                <option value="SI" <?php if ($buzon['ACTIVO'] == 'SI'){echo 'selected';}?>>
                                    Sí
                                </option>
                                <option value="NO" <?php if ($buzon['ACTIVO'] == 'NO'){echo 'selected';}?>>
                                    No
                                </option>
                            </select>
                        </td>
