...
<html>
    <head>
        ...
        <title><?php echo $titeliminar; ?> el Terminal COMDES</title>
...
?>
    <body>
        <h1><?php echo $titeliminar; ?> el Terminal TEI: <?php echo $row_terminal["TEI"]; ?> / ISSI: <?php echo $row_terminal["ISSI"]; ?> de la Flota <?php echo $row_flota["FLOTA"]; ?> (<?php echo $row_flota["ACRONIMO"]; ?>)</h1>
        <form action="update_terminal.php" method="POST" name="formterminal">
            <h2>Confirmar <?php echo $confeliminar; ?></h2>
            ...
            <div class="centro">
                ...
                <p class="error"><?php echo $menseliminar; ?></p>
                <table>
                    <tr>
                        <td class="borde">
